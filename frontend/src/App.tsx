    ...
    <div className="min-h-screen text-on-surface bg-background flex flex-col justify-between transition-colors duration-200">
      ...
      <header className="sticky top-0 bg-surface border-b border-outline-variant/35 z-40">
        <div className="flex justify-between items-center px-4 md:px-8 h-16 w-full max-w-7xl mx-auto">
          ...
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-primary/10 text-primary transition-transform duration-300 group-hover:scale-105">
              <HeartPulse className="w-5 h-5 animate-heartbeat" />
            </span>
            <span className="text-xl font-bold tracking-tight text-primary font-sans select-none relative">
              VitalCare
              <span className="absolute inset-0 pointer-events-none shine-text opacity-0 group-hover:opacity-100 group-hover:animate-shine transition-opacity duration-300">
                VitalCare
              </span>
            </span>
          </div>
      ...
      <footer className="hidden md:block w-full py-8 border-t border-outline-variant/35 bg-surface-container-lowest">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2 group cursor-pointer" onClick={() => setView("landing")}>
            ...
            <span className="text-on-surface-variant text-xs select-none ml-2">|</span>
