...
out center 40;`;
  ...
  if (sys >= 160 || dia >= 100) {
    ...
    htnClinicalColor = "text-amber-500 bg-amber-100/10";
  } else if (currentHtRisk >= 70) {
    htnClinicalStageEN = "BP Normal, but High Lifestyle Risk";
    htnClinicalStageBN = "রক্তচাপ স্বাভাবিক, কিন্তু জীবনযাত্রা উচ্চ ঝুঁকিপূর্ণ";
    htnClinicalColor = "text-red-500 bg-red-100/10";
  } else if (currentHtRisk >= 35) {
    htnClinicalStageEN = "BP Normal, but Elevated Lifestyle Risk";
    htnClinicalStageBN = "রক্তচাপ স্বাভাবিক, কিন্তু জীবনযাত্রা মাঝারি ঝুঁকিপূর্ণ";
    htnClinicalColor = "text-amber-500 bg-amber-100/10";
  }
  ...
  if (bmiCurrent >= 30 || assessmentData.familyHistory.diabetes) {
    ...
    dbClinicalColor = "text-amber-500 bg-amber-100/10";
  } else if (currentDbRisk >= 70) {
    dbClinicalStageEN = "Normal BMI, but High Lifestyle Risk";
    dbClinicalStageBN = "ওজন স্বাভাবিক, কিন্তু জীবনযাত্রা উচ্চ ঝুঁকিপূর্ণ";
    dbClinicalColor = "text-red-500 bg-red-100/10";
  } else if (currentDbRisk >= 35) {
    dbClinicalStageEN = "Normal BMI, but Elevated Lifestyle Risk";
    dbClinicalStageBN = "ওজন স্বাভাবিক, কিন্তু জীবনযাত্রা মাঝারি ঝুঁকিপূর্ণ";
    dbClinicalColor = "text-amber-500 bg-amber-100/10";
  }
